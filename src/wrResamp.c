...
static void interp_fast( float* codec
                       , float* tape
                       , float  coeff
                       , float* speed
                       , int    b_size
...
static void interp_normal( float* codec
                         , float* tape
                         , float  coeff
                         , float* speed
                         , int    b_size
...
static void interp_slow( float* codec
                       , float* tape
                       , float  coeff
                       , float* speed
                       , int    b_size
